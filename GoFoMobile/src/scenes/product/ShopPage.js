...
function ShopPage({navigation}) {
    ...
    function fetchData(isRefresh) {
        ...
        if (isRefresh === true ) {
            ...
            if (!loading && !isListEnd) {
                ...
                setLoading(false)
                api.getSellingByFullName(sellerInfo.local.fullName,page).then((response) => {
                    //setSellingList(response.data.result)
                    console.log('MERA .........  LOAD MORE 22  ..........   page: ',page,'Lenght ==>   ',response.data.result.length)
                    if (response.data.result.length > 0) {
                        setPage(page + 1);
                        console.log('MERA .........  LOAD MORE 33  ..........   page: ',page ,'lenght  ==>  ' ,response.data.result.length)
    ...
    function RenderList(navigation,data) {
        ...
        if (data.length > 0) {
            ...
            //     return (
            //         <View style={styles.noItemView}>
            //             <Text style = {styles.noItemText} >Không có sản phẩm nào đang bán 22</Text>
            //         </View>
            //     )
            // }
